...
export default class MontlyWalletBalanceSeeder extends Seeder {
  public async run(): Promise<void> {
    ...
    await mkBalance({
      balance: 100,
      created_at: new Date('2020-02-02 16:00:00'),
    });
    await mkBalance({
      balance: 200,
      created_at: new Date('2020-02-03 18:00:00'),
    });
    await mkBalance({
      balance: 1,
      created_at: new Date('2020-03-25 18:30:00'),
    });
  }
}
